...
<?php include 'footer.php' ;?>
 ...
 <script type="text/javascript">
Swal.fire({
  title: 'اللهم إنّي أسألك أن ترزقني علمًا نافعًا، وأن تنفعني بما علّمتني وأنت تزيدني علمًا، وأن تهبني من لدنك عقلًا منيرًا، ونفسًا منشرحة مقبلة على الدراسة والتحصيل العلمي برغبةٍ وحب، واجعلني يا ربّي سريع الحفظ حاد الذهن، واجعل ما رزقتني من العلم حجةً لي لا عليّ .',
